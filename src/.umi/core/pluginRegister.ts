...
import * as Plugin_2 from 'C:/Users/AlamLR/Desktop/proyecto/proyectoIS/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_6 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: 'C:/Users/AlamLR/Desktop/proyecto/proyectoIS/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
